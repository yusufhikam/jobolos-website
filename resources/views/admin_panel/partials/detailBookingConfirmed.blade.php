                ...
                <table class="photoshoot-info">
                    <tr>
                        <td>
                            ...
                            <p>{{ $payments->bookings->packages->name }}</p>
                    ...
                    <tr>
                        <td>
                            ...
                            <p>{{ $payments->bookings->payment_type == 'full' ? 'Full Payment' : 'DP' }}</p>
                            <p class="item-price">Rp {{ number_format($payments->bookings->total_harga, 0, ',', '.') }}
                            </p>
                        </td>
                        <td>
                ...
                <div class="signature-container">
                    <div class="signature">
                        <p style="margin-bottom: 10px;">
                            {{ Carbon::parse($payments->updated_at)->locale('id')->translatedFormat('l, j F Y') }}</p>
