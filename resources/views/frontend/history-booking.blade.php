...
@section('content')
    ...
    <div class="content-container " style="margin-top:7rem; margin-bottom:7rem;">
                ...
                <div class="d-flex justify-content-center">
                    <div class="card col-lg-7">
                        <div class="d-flex justify-content-between">
                            <a href="/jobolos/transactions" class="my-4 me-3 btn btn-warning"><i
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body">
                                            <div class="d-flex justify-content-between ">
                                                ...
                                                @else
                                                    @php
                                                        $payment = $bookList->payments->last();
                                                    @endphp
                                                    @if ($payment)
                                                        @if ($payment->status == 'pending')
                                                            <p>Payment Status : <span class=" rounded p-1 d-inline-block"
                                                        ...
                                                        @endif
                                                    @endif
                                                    @if ($bookList->status_pembayaran == 'cancelled')
                                                        <p>Status Booking : <span
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="d-flex justify-content-between ">
                                                                    ...
                                                                    @if ($bookList->payment_type == 'dp')
                                                                        <p class="bg-primary rounded p-1 d-inline-block">
                                                                            DP</p>
                                                                    @else
                                                                        <p class="bg-primary rounded p-1 d-inline-block">
                                                                            Full Payment</p>
