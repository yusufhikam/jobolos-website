...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-2">Album Gallery Management</h1>
                    <hr>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right m-2">
                        <li class="breadcrumb-item active">Album Gallery Management</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row my-3 ms-2 me-2 justify-content-between ">
                    ...
                    <div class="col-lg-6 mb-4">
                        <a href="/admin_panel/admin-add-photo">
                            <button class=" col-lg-4 col-sm-12 btn btn-primary"><i class="fa-solid fa-plus"></i> Photos
                                Management</button>
                        </a>
                    </div>
